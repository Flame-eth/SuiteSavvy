    ...
    <div className="footer">
      <div className="fLists">
        ...
        <ul className="fList">
          ...
          <li className="fListItem">Traveler Review Awards </li>
        </ul>
        ...
        <ul className="fList">
          ...
          <li className="fListItem">Become a partner</li>
          <li className="fListItem">Careers</li>
          <li className="fListItem">Privacy Policy</li>
          <li className="fListItem">Investor relations</li>
          <li className="fListItem">Terms and Condition</li>
        </ul>
      ...
      <div className="fTexts">
        <div className="fText">Copyright © 2023 Suite Savvy </div>
        <div className="fText">All right reserved </div>
      </div>
    </div>
  );
};
